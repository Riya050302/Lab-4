...
VL_INLINE_OPT QData Vcpu___024root___change_request_1(Vcpu___024root* vlSelf) {
    ...
    __req |= ((vlSelf->cpu__DOT__EQ ^ vlSelf->__Vchglast__TOP__cpu__DOT__EQ));
    VL_DEBUG_IF( if(__req && ((vlSelf->cpu__DOT__EQ ^ vlSelf->__Vchglast__TOP__cpu__DOT__EQ))) VL_DBG_MSGF("        CHANGE: cpu.sv:17: cpu.EQ\n"); );
    // Final
    vlSelf->__Vchglast__TOP__cpu__DOT__EQ = vlSelf->cpu__DOT__EQ;
    return __req;
}
